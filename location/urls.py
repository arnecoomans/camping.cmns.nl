...
urlpatterns = [
  ...
  path('location/<slug>/description/add/', views.AddDescriptionToLocation.as_view(), name='AddDescriptionToLocation'),
  ...
  path('location/<slug>/description/toggle:<int:descriptionid>/', views.deleteDescriptionFromLocation.as_view(), name='deleteDescriptionFromLocation'),
