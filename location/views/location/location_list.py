...
class LocationListMaster(FilterClass):
  ...
  def order_queryset(self, queryset):
    ...
    if order == 'distance':
      queryset = queryset.order_by('location__parent__parent__cached_average_distance_to_center', 'location__parent__cached_average_distance_to_center', 'location__cached_average_distance_to_center', 'name')
